...
public class Person extends IdentityEntity<Long> {
	...
	// @ManyToMany(targetEntity = Parent.class, cascade = { CascadeType.MERGE,
	// CascadeType.PERSIST })
	// @JoinTable(name = "ParentChild", joinColumns = { @JoinColumn(name =
	// "child_id", referencedColumnName = "id") }, inverseJoinColumns = {
